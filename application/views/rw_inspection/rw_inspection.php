...
<!--        Status
      ...
      //  }
        //if (in_array("Delete", $action)) {
            ...
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="rw_inspection_excel()">Excel</a> -->
...
<table id="rw_inspection" data-options="
    ...
    <thead>
        <tr>
            ...
            <th field="rw_inspection_date" width="100" align="center" formatter="myFormatDate">RW Inspection Date</th>
